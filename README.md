...
<!-- downloads:start v0.5.7 -->
<!-- Generated by `npm run release`; edit scripts/release.mjs instead of this block. -->
**Latest release: [v0.5.7](https://github.com/BenItBuhner/Murmur/releases/tag/v0.5.7)** · [All releases](https://github.com/BenItBuhner/Murmur/releases) · [Checksums](https://github.com/BenItBuhner/Murmur/releases/latest/download/SHA256SUMS.txt)

The links below always resolve to the current stable release (`/releases/latest`). Versioned
filenames for v0.5.7 are on the [release page](https://github.com/BenItBuhner/Murmur/releases/tag/v0.5.7).

```bash
# Linux / macOS
curl -fsSL https://github.com/BenItBuhner/Murmur/releases/latest/download/install.sh | bash

# Windows (PowerShell)
irm https://github.com/BenItBuhner/Murmur/releases/latest/download/install.ps1 | iex
```

| Platform | Download |
| --- | --- |
| Windows | [Installer (x64 + arm64)](https://github.com/BenItBuhner/Murmur/releases/latest/download/Murmur-setup.exe) · [Portable (x64)](https://github.com/BenItBuhner/Murmur/releases/latest/download/Murmur-portable.exe) |
| Windows x64 only | [Installer](https://github.com/BenItBuhner/Murmur/releases/latest/download/Murmur-x64-setup.exe) |
| Windows arm64 only | [Installer](https://github.com/BenItBuhner/Murmur/releases/latest/download/Murmur-arm64-setup.exe) |
| Linux x64 | [AppImage](https://github.com/BenItBuhner/Murmur/releases/latest/download/Murmur-x86_64.AppImage) · [.deb](https://github.com/BenItBuhner/Murmur/releases/latest/download/murmur_amd64.deb) |
| Linux arm64 | [AppImage](https://github.com/BenItBuhner/Murmur/releases/latest/download/Murmur-arm64.AppImage) · [.deb](https://github.com/BenItBuhner/Murmur/releases/latest/download/murmur_arm64.deb) |
| macOS (Apple silicon) | [.dmg](https://github.com/BenItBuhner/Murmur/releases/latest/download/Murmur-arm64.dmg) · [.zip](https://github.com/BenItBuhner/Murmur/releases/latest/download/Murmur-arm64.zip) |
| macOS (Intel) | [.dmg](https://github.com/BenItBuhner/Murmur/releases/latest/download/Murmur-x64.dmg) · [.zip](https://github.com/BenItBuhner/Murmur/releases/latest/download/Murmur-x64.zip) |
| Android | [APK](https://github.com/BenItBuhner/Murmur/releases/latest/download/Murmur-android.apk) |
<!-- downloads:end -->
