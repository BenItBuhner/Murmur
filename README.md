...
<!-- downloads:start v0.3.0 -->
<!-- Generated by `npm run release`; edit scripts/release.mjs instead of this block. -->
**Latest release: [v0.3.0](https://github.com/BenItBuhner/voxflow/releases/tag/v0.3.0)** · [All releases](https://github.com/BenItBuhner/voxflow/releases) · [Checksums](https://github.com/BenItBuhner/voxflow/releases/latest/download/SHA256SUMS.txt)

The links below always resolve to the current stable release (`/releases/latest`). Versioned
filenames for v0.3.0 are on the [release page](https://github.com/BenItBuhner/voxflow/releases/tag/v0.3.0).
...
```bash
npm run release -- 0.3.0      # bumps every version file + the README table, commits, tags v0.3.0
git push origin main v0.3.0   # the Release workflow builds and publishes the release
```
