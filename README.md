...
<!-- downloads:start v0.5.6 -->
<!-- Generated by `npm run release`; edit scripts/release.mjs instead of this block. -->
**Latest release: [v0.5.6](https://github.com/BenItBuhner/Murmur/releases/tag/v0.5.6)** · [All releases](https://github.com/BenItBuhner/Murmur/releases) · [Checksums](https://github.com/BenItBuhner/Murmur/releases/latest/download/SHA256SUMS.txt)

The links below always resolve to the current stable release (`/releases/latest`). Versioned
filenames for v0.5.6 are on the [release page](https://github.com/BenItBuhner/Murmur/releases/tag/v0.5.6).
